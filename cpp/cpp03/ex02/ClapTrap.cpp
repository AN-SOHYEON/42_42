...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/02 15:28:15 by san               #+#    #+#             */
/*   Updated: 2022/08/02 15:28:16 by san              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap() { std::cout << "Destructor of claptrap " << name << " called" << std::endl; }
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	energy_point--;
	hit_point = hit_point + amount;
	std::cout << "\nTrap " << name << " be repaired!" << std::endl;
	std::cout << name << "'s hit_point is " << hit_point << " now!" << std::endl;
	std::cout << "Trap " << name << "'s energy is " << energy_point << "points..\n"<< std::endl;
}
